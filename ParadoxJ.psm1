...
function Write-Theme {
    ...
    $prompt += Write-Prompt $timeStamp -ForegroundColor $sl.Colors.TimestampColor
...
$sl.Colors.PromptForegroundColor = [ConsoleColor]::DarkGray
...
$sl.Colors.GitBackgroundColor = [ConsoleColor]::DarkGray
